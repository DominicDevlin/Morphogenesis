...
/*stem-cell system project params*/
    ...
    J_stem=4;
    J_diff=6;
    J_med=3.5;//0.5*J_diff+0.5;//0.25 + 0.5*J_diff;//0.5+0.5*J_diff;
    J_stem_diff=6;//J_diff + 0.5;//(J_diff - J_stem);
    // J_med=8;
    // J_med2=J_med+10;
    ...
    secr_rate[0] = 0.00712447;//126251;// 2.039e12*pow((J_stem+14.567),-12.1771)+0.0018588;// 0.00214; // 2.4e-3;
