...
public:
  ...
  double discrete_decay(vector<double>& gene_list, double conc, int gene_n, double morph=0);
  ...
  // personal random numbers for xoshiro
...
private:
  ...
  void get_neighbours(int cell_n, std::vector<double>& genes);
